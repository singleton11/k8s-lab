...
import (
	...
	"github.com/singleton11/k8s-lab/pkg/handlers"
	"github.com/singleton11/k8s-lab/pkg/logger"
	stdlog "github.com/singleton11/k8s-lab/pkg/logger/standard"
	"github.com/singleton11/k8s-lab/pkg/router"
	"github.com/singleton11/k8s-lab/pkg/router/bitroute"
	"github.com/singleton11/k8s-lab/pkg/version"
)
